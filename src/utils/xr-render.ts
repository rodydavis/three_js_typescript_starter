...
light.add(
  new Mesh(
    new SphereGeometry(sceneRadius / 10, 32, 32),
...
const floorTexture = new TextureLoader().load(
  "https://cdn.glitch.com/3423c223-e1e5-450d-8cfa-2f5215104916%2Fmemphis-mini.png?v=1579618577700"
);
...
export { renderer, scene, rafCallbacks, cameraGroup, camera };
